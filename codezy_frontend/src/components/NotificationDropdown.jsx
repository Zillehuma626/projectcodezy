        ...
        <>
          ...
          <div className="absolute right-0 mt-3 w-[380px] bg-white rounded-3xl shadow-2xl border border-gray-100 z-50 overflow-hidden animate-in fade-in zoom-in duration-200">
              ...
              {loading ? (
                ...
                notifications.map((n) => (
                  <div
                    ...
                    className={`p-4 flex gap-4 border-b border-gray-50 hover:bg-gray-50 transition-colors cursor-pointer ${
            ...
            <div className="p-3 bg-gray-50/50 border-t border-gray-50 text-center">
              <button className="text-[11px] font-bold text-gray-400 hover:text-purple-600 transition-colors uppercase tracking-widest">
                View All Activity
              </button>
            </div>
          </div>
